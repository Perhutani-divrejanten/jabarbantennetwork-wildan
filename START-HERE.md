...
Your Jabar Banten Network website now has a **simplified Google Apps Script Web App integration**. Everything is configured and ready to use!
...
cd "d:\Magang\Perhutani\Jabar Banten Network"
